...
public record EquipoDto(int Id, int ProductoId, string Producto, string Imei, string? Imei2, string EstadoFisico, decimal CostoCompra, DateOnly FechaIngreso, string EstadoVenta);
