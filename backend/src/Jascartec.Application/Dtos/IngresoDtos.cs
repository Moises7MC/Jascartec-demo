...
public record IngresoDto(int Id, DateOnly Fecha, int ProveedorId, string Proveedor, string? NumeroFactura, IReadOnlyList<EquipoDto> Equipos, IReadOnlyList<IngresoItemDto> Items);
