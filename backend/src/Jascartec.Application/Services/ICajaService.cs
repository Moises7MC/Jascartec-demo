...
{
    Task<CajaSesionDto?> ObtenerAbiertaAsync(int sucursalId, CancellationToken ct = default);
    Task<IReadOnlyList<CajaSesionDto>> ListarAsync(DateOnly? desde, DateOnly? hasta, int? sucursalId, CancellationToken ct = default);
